...
<body>
    <table border="1">
        <tr>
            ...
            <table border="1">
                    <form action="s_studentclasses.jsp" method="get">
            ...
            <%
                    ...
                    if (action != null && action.equals("search")) {
                        ...
                        String query2 = "select CLASSES.COURSENUMBER, CLASSTITLE, SECTIONS.SECTIONID, QUARTER, YEAR, UNITS from STUDENT, CURRENTENROLLMENT, COURSES, CLASSES, SECTIONS where STUDENT.STUDENTID = CURRENTENROLLMENT.STUDENTID and CURRENTENROLLMENT.COURSENUMBER = CLASSES.COURSENUMBER and CURRENTENROLLMENT.SECTIONID = SECTIONS.SECTIONID and COURSES.COURSENUMBER = CURRENTENROLLMENT.COURSENUMBER and SSN = ?";
