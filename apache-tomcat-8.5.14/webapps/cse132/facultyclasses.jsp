        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE facultyclasses SET SECTIONID = ?, WHENTAUGHT = ? WHERE FACULTYNAME = ?");
                        
                        pstmt.setInt(1,Integer.parseInt(request.getParameter("SECTIONID")));
                        pstmt.setString(2, request.getParameter("WHENTAUGHT"));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM facultyclasses WHERE FACULTYNAME = ? AND SECTIONID = ?");
            ...
            %>
                    ...
                    <tr>
                        <form action="facultyclasses.jsp" method="get">
                            ...
                            <%-- Get the WHENTAUGHT --%>
                            <td>
                                <input value="<%= rs.getString("WHENTAUGHT") %>" 
                                    name="WHENTAUGHT" size="17">
                            </td>   
                            <%-- Button --%>
                            <td>
